<xsl:stylesheet version="1.0" exclude-result-prefixes="xsl msxsl ddwrt" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:ddwrt="http://schemas.microsoft.com/WebParts/v2/DataView/runtime" xmlns:asp="http://schemas.microsoft.com/ASPNET/20" xmlns:msxsl="urn:schemas-microsoft-com:xslt" xmlns:SharePoint="Microsoft.Sharepoint.WebControls">
  ...
  <xsl:param name="ColName_1">Name</xsl:param>
  <xsl:param name="ColName_2">ParentOrganizationId</xsl:param>
  <xsl:param name="ColName_3">IsActive</xsl:param>
    ...
    <table CtxNum="1" cellspacing="0" class="ms-unselectedtitle">
      <xsl:if test="$fieldname">
        <xsl:attribute name="onmouseover">
          OnMouseOverAdHocFilter(this, '<xsl:value-of select="$filterString" />')
        </xsl:attribute>
      </xsl:if>
      <tr>
  ...
  <xsl:template name="dvt_1">
    ...
    <table id="BdwpRows" border="0" width="100%" cellpadding="2" cellspacing="0">
      ...
      <tr valign="top">
        ...
        <th class="ms-vh" align="left">
          <xsl:call-template name="dvt.headerfield" ddwrt:atomic="1">
            <xsl:with-param name="fieldname">@ParentOrganizationId</xsl:with-param>
            <xsl:with-param name="fieldtitle">
        ...
        <th class="ms-vh" align="left">
          <xsl:call-template name="dvt.headerfield" ddwrt:atomic="1">
            <xsl:with-param name="fieldname">@IsActive</xsl:with-param>
            <xsl:with-param name="fieldtitle">
  ...
  <xsl:template name="dvt_1.rowview">
    <tr>
      ...
      <td class="ms-vb">
        ...
        <a onclick="OpenPopUpPage('../Lists/Organization/EditForm.aspx?ID={@BdcIdentity}', null, null, null, null);" href="#">
      ...
      <td class="ms-vb">
        ...
        <xsl:value-of select="@ParentOrganizationId" />
      </td>
      <td class="ms-vb">
        <xsl:attribute name="style">
          <xsl:choose>
